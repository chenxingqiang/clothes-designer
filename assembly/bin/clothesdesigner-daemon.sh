...
function setMainClass {
  if [ "$service" == $CHAT_SERVICE ]; then
    main_class="com.iechor.clothesdesigner.ChatLauncher"
  elif [ "$service" == $HEADLESS_SERVICE ]; then
    main_class="com.iechor.clothesdesigner.HeadlessLauncher"
  else
    main_class="com.iechor.clothesdesigner.StandaloneLauncher"
  fi
}
