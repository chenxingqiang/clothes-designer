package com.iechor.clothesdesigner.auth.api.authentication.config;
...
public class AuthenticationConfig {
    ...
    @Value("${s2.authentication.token.default.appKey:clothesdesigner}")
    private String tokenDefaultAppKey;

    @Value(
            "${s2.authentication.token.appSecret:clothesdesigner:WIaO9YRRVt+7QtpPvyWsARFngnEcbaKBk"
