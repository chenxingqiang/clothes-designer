package com.iechor.clothesdesigner.headless.server.calcite;
...
import com.iechor.clothesdesigner.headless.api.pojo.response.SqlParserResp;
...
import com.iechor.clothesdesigner.headless.core.translator.calcite.planner.AggPlanner;
...
class HeadlessParserServiceTest {
    ...
    public static SqlParserResp parser(
            SemanticSchema semanticSchema, MetricQueryParam metricQueryParam, boolean isAgg) {
        ...
        try {
            ...
            EngineType engineType =
                    EngineType.fromString(
                            semanticSchema.getSemanticModel().getDatabase().getType());
    ...
    public void test() throws Exception {
        ...
        SemanticSchemaManager.update(
                semanticSchema, SemanticSchemaManager.getDatasource(datasource));
        ...
        metricCommand2.setDimensions(
                new ArrayList<>(
                        Arrays.asList(
                                "sys_imp_date",
                                "user_name__department",
                                "user_name",
                                "user_name__page")));
    ...
    private static void addDepartment(SemanticSchema semanticSchema) {
        ...
        semanticSchema
                .getDatasource()
                .put("user_department", SemanticSchemaManager.getDatasource(datasource));
