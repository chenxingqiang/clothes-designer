package com.iechor.clothesdesigner.headless.server.aspect;
...
import com.iechor.clothesdesigner.common.pojo.QueryAuthorization;
...
import com.iechor.clothesdesigner.common.pojo.exception.InvalidPermissionException;
...
import com.iechor.clothesdesigner.headless.server.utils.QueryStructUtils;
...
public class S2DataPermissionAspect {
    ...
    @Pointcut("@annotation(com.iechor.clothesdesigner.headless.server.annotation.S2DataPermission)")
    ...
    private void checkColPermission(
        ...
        Set<String> sensitiveBizNameInQuery =
                bizNamesInQueryReq.parallelStream()
