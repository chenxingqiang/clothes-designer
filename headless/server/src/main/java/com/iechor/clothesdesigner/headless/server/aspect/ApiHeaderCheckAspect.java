...
import com.iechor.clothesdesigner.common.pojo.Pair;
import com.iechor.clothesdesigner.common.pojo.exception.InvalidArgumentException;
import com.iechor.clothesdesigner.common.util.SignatureUtils;
...
public class ApiHeaderCheckAspect {
    ...
    @Pointcut("@annotation(com.iechor.clothesdesigner.headless.server.annotation.ApiHeaderCheck)")
