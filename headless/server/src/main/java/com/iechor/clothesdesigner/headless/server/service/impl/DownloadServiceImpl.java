...
import com.iechor.clothesdesigner.headless.core.utils.DataTransformUtils;
import com.iechor.clothesdesigner.headless.server.facade.service.SemanticLayerService;
import com.iechor.clothesdesigner.headless.server.pojo.DataDownload;
...
public class DownloadServiceImpl implements DownloadService {
    ...
    public void downloadByStruct(
        ...
        String fileName =
                String.format(
                        "%s_%s.xlsx",
                        "clothesdesigner", DateUtils.format(new Date(), DateUtils.FORMAT));
