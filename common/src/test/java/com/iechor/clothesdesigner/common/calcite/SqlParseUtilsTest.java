package com.iechor.clothesdesigner.common.calcite;
...
class SqlParseUtilsTest {
    ...
    void addFieldToSql() throws SqlParseException {
        String addFieldToSql =
                SqlParseUtils.addFieldsToSql(
    ...
    void getSqlParseInfo() {
        ...
        List<String> collect =
                sqlParserInfo.getAllFields().stream()
