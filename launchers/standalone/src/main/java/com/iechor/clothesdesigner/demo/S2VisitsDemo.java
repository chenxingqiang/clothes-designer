package com.iechor.clothesdesigner.demo;
...
import com.iechor.clothesdesigner.auth.api.authorization.pojo.AuthRule;
import com.iechor.clothesdesigner.chat.server.agent.Agent;
import com.iechor.clothesdesigner.chat.server.agent.AgentConfig;
import com.iechor.clothesdesigner.chat.server.agent.AgentToolType;
import com.iechor.clothesdesigner.chat.server.agent.LLMParserTool;
import com.iechor.clothesdesigner.chat.server.agent.MultiTurnConfig;
import com.iechor.clothesdesigner.chat.server.agent.RuleParserTool;
import com.iechor.clothesdesigner.chat.server.plugin.ChatPlugin;
import com.iechor.clothesdesigner.chat.server.plugin.PluginParseConfig;
import com.iechor.clothesdesigner.chat.server.plugin.build.WebBase;
import com.iechor.clothesdesigner.chat.server.plugin.build.webpage.WebPageQuery;
import com.iechor.clothesdesigner.chat.server.plugin.build.webservice.WebServiceQuery;
import com.iechor.clothesdesigner.common.pojo.JoinCondition;
...
import com.iechor.clothesdesigner.common.pojo.enums.SensitiveLevelEnum;
...
import com.iechor.clothesdesigner.headless.api.pojo.DataSetModelConfig;
import com.iechor.clothesdesigner.headless.api.pojo.Dim;
import com.iechor.clothesdesigner.headless.api.pojo.DimensionTimeTypeParams;
import com.iechor.clothesdesigner.headless.api.pojo.Field;
import com.iechor.clothesdesigner.headless.api.pojo.FieldParam;
import com.iechor.clothesdesigner.headless.api.pojo.Identify;
import com.iechor.clothesdesigner.headless.api.pojo.Measure;
import com.iechor.clothesdesigner.headless.api.pojo.MeasureParam;
import com.iechor.clothesdesigner.headless.api.pojo.MetricDefineByFieldParams;
import com.iechor.clothesdesigner.headless.api.pojo.MetricDefineByMeasureParams;
import com.iechor.clothesdesigner.headless.api.pojo.MetricDefineByMetricParams;
import com.iechor.clothesdesigner.headless.api.pojo.MetricParam;
import com.iechor.clothesdesigner.headless.api.pojo.ModelDetail;
import com.iechor.clothesdesigner.headless.api.pojo.enums.DimensionType;
import com.iechor.clothesdesigner.headless.api.pojo.enums.IdentifyType;
import com.iechor.clothesdesigner.headless.api.pojo.enums.MetricDefineType;
import com.iechor.clothesdesigner.headless.api.pojo.enums.SemanticType;
...
public class S2VisitsDemo extends S2BaseDemo {
    ...
    boolean checkNeedToRun() {
        ...
        for (DomainResp domainResp : domainList) {
            if (domainResp.getBizName().equalsIgnoreCase("clothesdesigner")) {
                log.info("Already exist domain:clothesdesigner, no need to run demo");
                return false;
            }
        }
        return true;
    ...
    public DomainResp addDomain() {
        ...
        domainReq.setBizName("clothesdesigner");
